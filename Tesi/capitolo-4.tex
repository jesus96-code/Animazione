...
\begin{center}
     ...
     \caption{Struttura scheletrica} \label{fig:gera}
\end{center}
\end{figure}
...
\begin{itemize}
    ...
    \item impatto delle operazioni di rigging e retargeting sulla scena di Blender
\end{itemize}
    
L'intera procedura si è dimostrata efficiente per modelli complessità ridotta come quelli considerati, garantendo un'interazione fluida e un processo automatizzato rapido.
